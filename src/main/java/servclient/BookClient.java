...
import servclient.BookInterface;
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        try {
            ...
            while (true) {
                ...
                if ("commands".equals(command.toLowerCase())) {
                    ...
                    System.out.println();
                } else if ("show books".equals(command.toLowerCase())) {
                    System.out.println("Books currently in store: ");
                    book.printLibrary();
                } else if ("add book".equals(command.toLowerCase())) {//bs.AddBook();
                    book.AddBook();
                    book.printLibrary();
                } else if ("remove book".equals(command.toLowerCase())) {
                    book.RemoveBook();
                } else if ("sort books".equals(command.toLowerCase())) {
                    ...
                    book.printLibrary();
                } else if ("write to file".equals(command.toLowerCase())) {
                    bookClient.WriteFile(book);
                } else if ("read from file".equals(command.toLowerCase())) {
                ...
                } else if ("length".equals(command.toLowerCase())) {
                    book.lengthOfMassive();
                } else if ("find book".equals(command.toLowerCase())) {
                    book.FindBook();
                }
            }
